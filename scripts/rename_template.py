...
It renames all the occurrences of pointfoot (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the pointfoot folder
        os.rename(
            os.path.join(root_dir_path, "exts", "pointfoot", "pointfoot"),
            os.path.join(root_dir_path, "exts", "pointfoot", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "pointfoot"), os.path.join(root_dir_path, "exts", new_name))
